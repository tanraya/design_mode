(function( $ ) {
  $.fn.DesignModePluginImage = function(o) { this.initialize(o) }

  $.fn.DesignModePluginImage.prototype = {
    initialize: function(o) {
      ...
      this.dialog.show()
      this.dialog.el.addClass('design-mode-plugin-image')
      this.build()
    },
    ...
    switchTabs: function() {
      ...
      this.tabsArea.on('click', '.design-mode-tab', function(e){
        e.preventDefault();
