(function( $ ) {
  $.fn.DesignModeToolbar = function(iframe, o) {
    var o = $.extend({
  ...
  $.fn.DesignModeToolbar.prototype = {
    iframe : null,
    el     : null,
    ...
    initialize: function(iframe, o) {
      this.iframe = iframe
      this.o      = o
      this.x      = $.fn.DesignModeToolbarDefault // TODO make it pretty
      this.l      = $.fn.DesignModeLanguages.ru // TODO make it pretty
